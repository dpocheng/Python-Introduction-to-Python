...
def handle_commands(C: list) -> list:
    ...
    while True:
        ...
        if response=="q":
            ...
            number = int(input("Enter the percentage: "))
            C = Collection_change_prices(C, number)
            print(Collection_str(C))
        else:
...
def Collection_change_prices(C: list, number: int) -> list:
